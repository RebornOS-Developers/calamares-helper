...
CONFIGURATION_SCRIPT_PATH="$SCRIPT_DIRECTORY/calamares-configuration/rebornos_scripts/build_archlinux_package.sh"
BRANDING_SCRIPT_PATH="$SCRIPT_DIRECTORY/calamares-branding/rebornos_scripts/build_archlinux_package.sh"
CORE_SCRIPT_PATH="$SCRIPT_DIRECTORY/calamares-core/rebornos_scripts/build_archlinux_package.sh"
